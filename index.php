...
<html lang="en">
  ...
  <body>
			 ...
			 ?>			
				...
				<div class="mt-5 border rounded">   
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div class="col-12 fors" style="display: none;">
							<form action="update.php" method="GET">
								<input type="" name="gk1" placeholder="id" value="<?php 
								 		echo $stroka["id"]?>" class="col-12 text-center" style="height: 50px;">	
								<input type="" name="gl1" placeholder="text" value="<?php 
								 		echo $stroka["text"]?>" class="col-12 text-center" style="height: 50px;">
								<input type="" name="gh1" placeholder="img" value="<?php 
								 		echo $stroka["img"]?>" class="col-12 mt-2 text-center" style="height: 50px;">
								<div class="text-center">
									<button class="mt-2 bg-success" style="font-family: arial;font-size: 25px;">Редактировать</button>
								</div>
							</form>
						</div>
						<div class="text-center btn2">
							<button class="mt-2 bg-success" style="font-family: arial;font-size: 25px;display: block">Редактировать</button>
						</div>		
						<div>
							<p>5 недель назад</p>
						</div>				
    ...
    <script type="">
    	let bt = document.querySelectorAll(".btn2")
	    let f = document.querySelectorAll(".fors")
